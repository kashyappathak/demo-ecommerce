<?php $__env->startSection('category', 'Home Product'); ?>
            ...
            <?php if($category->count() > 0): ?>
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="align-middle"><?php echo e($rs->category); ?></td>
                        ...
                        <td class="align-middle">
                            ...
                            <?php echo e($rs->available); ?>

                        </td>
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="<?php echo e(route('categories.show', $rs->id)); ?>" type="button" class="btn btn-info"
                                    onclick="showDetail('<?php echo e(route('categories.show', $rs->id)); ?>')">View</a>
                                <a href="<?php echo e(route('categories.edit', $rs->id)); ?>" type="button" class="btn btn-warning"
                                    onclick="showEdit('<?php echo e(route('categories.edit', $rs->id)); ?>')">Edit</a>

                                <form action="<?php echo e(route('categories.destroy', $rs->id)); ?>" method="POST"
                                    class="btn btn-danger p-0"
                                    onsubmit="event.preventDefault(); confirmDelete('<?php echo e(route('categories.destroy', $rs->id)); ?>')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\demo-ecommerce\resources\views/categories/index.blade.php ENDPATH**/ ?>