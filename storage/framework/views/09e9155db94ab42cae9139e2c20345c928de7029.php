...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="category" class="form-control" placeholder="Category" value="<?php echo e($category->category); ?>"
                readonly>
        </div>
        <div class="col mb-3">
            ...
            <img id="imagePreview" src="<?php echo e(asset('admin_assets/img/' . $category->image)); ?>" alt="Image"
        ...
        <div class="col mb-3">
            ...
            <select name="status" id="" class="form-control" value="<?php echo e($category->status); ?>"
        ...
        <div class="col mb-3">
            ...
            <select name="available" id="" class="form-control" value="<?php echo e($category->available); ?>"
                onchange="showSelectedCategory(this)">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\demo-ecommerce\resources\views/categories/show.blade.php ENDPATH**/ ?>