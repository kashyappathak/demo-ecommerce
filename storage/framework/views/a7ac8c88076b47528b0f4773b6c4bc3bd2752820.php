                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="<?php echo e(route('register.save')); ?>" method="POST" class="user" id="registerForm">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <script>
                                ...
                                document.getElementById('registerForm').addEventListener('submit', function(event) {
                                    ...
                                    $.ajax({
                                        url: "<?php echo e(route('check.email.unique')); ?>",
                                        method: "POST",
                                        data: {
                                            email: email
                                        },
                            ...
                            <hr>
                            <div class="text-center">
                                <a style="text-decoration: none;" class="small" href="<?php echo e(route('login')); ?>">Already
...
<?php /**PATH D:\demo-ecommerce\resources\views/auth/register.blade.php ENDPATH**/ ?>